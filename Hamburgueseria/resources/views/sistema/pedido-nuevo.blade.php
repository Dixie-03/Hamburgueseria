        ...
        <form id="form1" method="POST">
            <div class="row">
                ...
                <div class="form-group col-lg-6">
                    ...
                    <input type="text" id="txtDescripcion" name="txtDescripcion" class="form-control" value="{{ $pedido->descripcion }}">
                </div>
                <div class="form-group col-lg-6">
                    <label>Total:*</label>
                ...
                <div class="form-group col-lg-6">
                    ...
                    <select name="lstSucursal" id="lstSucursal" class="form-control" value="">
                        ...
                        @if ($sucursal->idsucursal == $pedido->fk_idsucursal)
                             <option value="{{ $sucursal->idsucursal }}" selected>{{ $sucursal->descripcion }}</option>
                             @else 
